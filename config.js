...
// trends
    exports.journal = "SELECT BatchId as xaxis, EntityTopicDistribution.TopicId as topicId, NormWeight as weight, TopicDescription.Title as title, TopicDescription.VisibilityIndex, EntityId as ids FROM EntityTopicDistribution INNER JOIN TopicDescription ON TopicDescription.TopicId = EntityTopicDistribution.TopicId WHERE EntityType = 'JournalTrend' AND TopicDescription.ExperimentId=EntityTopicDistribution.ExperimentId and EntityTopicDistribution.ExperimentId = ?";
    // -- and EntityId='0163-5948'
    exports.corpus = "SELECT BatchId as xaxis,  EntityTopicDistribution.TopicId as topicId, NormWeight as weight, TopicDescription.Title as title, TopicDescription.VisibilityIndex FROM EntityTopicDistribution INNER JOIN TopicDescription ON TopicDescription.TopicId = EntityTopicDistribution.TopicId  AND TopicDescription.ExperimentId=EntityTopicDistribution.ExperimentId AND VisibilityIndex>2 WHERE EntityType = 'CorpusTrend' and EntityTopicDistribution.ExperimentId = ?";
    
    exports.conference = "SELECT BatchId as xaxis, EntityTopicDistribution.TopicId as topicId, NormWeight as weight, TopicDescription.Title as title, TopicDescription.VisibilityIndex, EntityId as ids FROM EntityTopicDistribution INNER JOIN TopicDescription ON TopicDescription.TopicId = EntityTopicDistribution.TopicId WHERE EntityType = 'ConferenceTrend' AND TopicDescription.ExperimentId=EntityTopicDistribution.ExperimentId and EntityTopicDistribution.ExperimentId = ?";
