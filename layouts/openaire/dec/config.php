...
$title = "Health Tender Review";								// title of the webpage
$trends_title = "Health Tender Trends";								// title of the webpage when ACM
$chord_title = "Connectivity of Health Tender Grants / Subdivision";								// title of the webpage when ACM
$subtitle = "(December, 21 2015)";								// subtitle of the webpage
...
$expsimilarity = 0.6;	///0.6		// similarity for querying the database ... for the first experiment
